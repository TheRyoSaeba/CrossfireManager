...
namespace KLASSES {
    ...
    public:
        union
        {
            ...
            DEFINE_MEMBER_N(0x0680, int8_t, isRespawn);
            DEFINE_MEMBER_N(0x06E0, int8_t, isDead);
            DEFINE_MEMBER_N(0x0708, void*, pCharacterHitBox);
    ...
    public:
        ...
        {
            auto fx = localPlayer.characFX;
            if (!fx)
                return WeaponType::Knife;

            auto currentWeapon = mem.Read<CWeapon*>(reinterpret_cast<uintptr_t>(fx) + offsetof(pCharacterFx, WeaponOnHand));
            if (!currentWeapon)
                return WeaponType::Knife;

            auto wClass = mem.Read<int16_t>(reinterpret_cast<uintptr_t>(currentWeapon) + offsetof(CWeapon, WeaponClass));
            return static_cast<WeaponType>(wClass);
        }
    };
    ...
    public:
        union
        {
            ...
            DEFINE_MEMBER_N(0x0050, pCamera*, CCamera);
            DEFINE_MEMBER_N(0x0098, void*, CWorldPropsClnt);
            DEFINE_MEMBER_N(0x00A0, pPlayerClntBase*, CPlayerClntBase);
            DEFINE_MEMBER_N(0x00A8, int32_t, ingame);
            DEFINE_MEMBER_N(0x00C0, void*, CLTClient);
            DEFINE_MEMBER_N(0x0110, void*, CameraInstance);
            DEFINE_MEMBER_N(0x02B0, void*, CGameUI);
            DEFINE_MEMBER_N(0x02A0, char, NickName[16]);
            DEFINE_MEMBER_N(0x02F0, void*, EntityStart);
            DEFINE_MEMBER_N(0x0334, int32_t, Health);
        };
    ...
    public:
        union
        {
            ...
            DEFINE_MEMBER_N(0x2958, pBoneArray*, BoneArray);
        };
