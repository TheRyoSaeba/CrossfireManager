...
________:00007FF856409ADD                 movzx   eax, byte ptr [rcx+rbp+2E8h]
    ...
    */
    constexpr auto MY_OFFSET_PATTERN =
        "0F B6 85 ? ? ? ? 48 69 C8 ? ? ? ? 0F B6 84 29 ? ? ? ? 48 8B 2D ? ? ? ? 40 3A F8 40 0F BE CF 41 0F 94 C4";
...
________:00007FF856409ADD                 movzx   eax, byte ptr [rcx+rbp+2E8h]
    ...
    */
    constexpr auto MY_PLAYERSIZE_PATTERN =
        "48 69 C8 ? ? ? ? 0F B6 84 29 ? ? ? ? 48 8B 2D ? ? ? ? 40 3A F8 40 0F BE CF 41 0F 94 C4";
    ...
    */
    ...
    inline  uintptr_t dwCPlayerStart = 0x2F0;
